...
class CheckGoogleAnalytic
{
    ...
    public function check()
    {
        ...
        foreach ($companies as $company) {
            ...
            $roistatConfig->googleAnalytics()->create($convertedAnalyticData);
            if ((isset($convertedAnalyticData['visitsCost'])) && ($convertedAnalyticData['visitsCost'] > $company->roistatConfig->google_limit_amount)) {
                $company->clearEmailNotificationLastSend(EmailNotification::ROISTAT_GOOGLE_TYPE);
            }
        }
